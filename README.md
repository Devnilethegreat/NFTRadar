# NFTRadar: AI-powered NFT market scanner and collection sentiment analyser Implementation
> Advanced javascript solution leveraging modern architecture patterns and cutting-edge AI technology.

NFTRadar monitors secondary-market listings, social mentions, and wash-trading signals across major NFT marketplaces, surfacing emerging collections and risk-adjusted rarity arbitrage opportunities.

NFTRadar's key benefits include:
...
```bash
git clone https://github.com/Devnilethegreat/NFTRadar.git
cd NFTRadar
```
...
- **2024-10-28** — Expand test coverage for edge cases
